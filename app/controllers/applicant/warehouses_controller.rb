class Applicant::WarehousesController < Applicant::BaseController
  ...
  def destroy
    @warehouse.destroy
    respond_to do |format|
      format.html { redirect_to applicant_warehouses_url, notice: 'Warehouse was successfully destroyed.' }
  ...
  private
    ...
    def warehouse_params
      params.require(:warehouse).permit(:name, :owner_name, :state_id, :district_id, :post_office, :police_station, :pincode, :postal_address, :applicant_user_id, :status)
    end
end
